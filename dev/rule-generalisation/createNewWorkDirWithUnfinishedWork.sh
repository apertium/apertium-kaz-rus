...
MYTMPDIR=/work/vmsanchez/rules/tmps

FULLEULERPATH="/home/vmsanchez/results/experiments-linear-l5-$SL-$TL/$BILID/shuf$SIZE"

NEWEULERPATH="/home/vmsanchez/results/experiments-linear-l5-$SL-$TL/$BILID-unfinished/shuf$SIZE"
...
ssh vmsanchez@euler.iuii.ua.es "bash /home/vmsanchez/sources/apertium-transfer-tools-generalisation/rule-generalisation/getUnfinishedParts.sh $FULLEULERPATH $FILTERING_METHOD" > $UNFININSHEDPARTS_F
